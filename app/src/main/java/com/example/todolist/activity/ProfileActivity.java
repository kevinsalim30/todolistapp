...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        setUserData();
        Toast.makeText(ProfileActivity.this,"Profile started", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onRestart() {
        super.onRestart();
        setUserData();
        Toast.makeText(ProfileActivity.this,"Profile restarted", Toast.LENGTH_SHORT).show();
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Toast.makeText(ProfileActivity.this,"Profile closed", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void onStop() {
        super.onStop();
        Toast.makeText(ProfileActivity.this,"Profile Stopped", Toast.LENGTH_SHORT).show();
    }
